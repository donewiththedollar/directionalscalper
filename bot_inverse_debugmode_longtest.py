    ...
    with Live(generate_main_table(), refresh_per_second=2) as live:
        while True:
            try:
                ...
                time.sleep(0.01)
                if inverse_mode & inverselong_mode == False:
                    get_short_positions()
                    time.sleep(0.01)
                    get_long_positions()
                    time.sleep(0.01)
