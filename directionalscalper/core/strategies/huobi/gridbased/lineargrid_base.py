...
from directionalscalper.core.strategies.huobi.huobi_strategy import HuobiStrategy  # New Huobi-specific strategy class
from directionalscalper.core.exchanges.huobi import HuobiExchange  # Huobi exchange integration
...
class LinearGridBaseFuturesHuobi(HuobiStrategy):  # Extend from Huobi-specific strategy
