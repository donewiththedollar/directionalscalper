    ...
    def play_the_spread_entry_and_tp(self, symbol, open_orders, long_dynamic_amount, short_dynamic_amount, long_pos_qty, short_pos_qty, long_pos_price, short_pos_price):
        ...
        if long_pos_qty > 0:
            if sell_walls:
                ...
                long_take_profit = sell_walls[0] - long_trading_fee
                ...
                long_take_profit = avg_top_asks - long_trading_fee
        ...
        if short_pos_qty > 0:
            if buy_walls:
                ...
                short_take_profit = buy_walls[0] + short_trading_fee
                ...
                short_take_profit = avg_top_bids + short_trading_fee
