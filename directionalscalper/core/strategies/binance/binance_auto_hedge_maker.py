...
logging = Logger(logger_name="BinanceAutoHedgeMaker", filename="BinanceAutoHedgeMaker.log", stream=True)

class BinanceAutoHedgeMakerStrategy(BinanceStrategy):
    ...
    def run(self, symbol):
        ...
        with live:
            ...
            # Get API data
                ...
                self.binance_auto_hedge_entry_maker(trend, one_minute_volume, five_minute_distance, min_vol, min_dist, should_long, 
                ...
                if long_pos_qty != 0 and long_take_profit is not None:     
                    self.binance_hedge_placetp_market(symbol, long_pos_qty, long_take_profit, "LONG", open_orders)

                if short_pos_qty != 0 and short_take_profit is not None:
                    self.binance_hedge_placetp_market(symbol, abs(short_pos_qty), short_take_profit, "SHORT", open_orders)
