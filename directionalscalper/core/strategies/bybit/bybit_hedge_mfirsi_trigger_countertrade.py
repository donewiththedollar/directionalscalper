...
logging = Logger(logger_name="BybitHedgeMFIRSITriggerCountertrade", filename="BybitHedgeMFIRSITriggerCountertrade.log", stream=True)
                ...
                if one_minute_volume is not None and five_minute_distance is not None:
                    if one_minute_volume > min_vol and five_minute_distance > min_dist:
                        ...
                        if mfi is not None and isinstance(mfi, str):
                            ...
                            elif mfi.lower() == "short" and long_pos_qty < self.max_long_trade_qty and best_bid_price < long_pos_price:
                            ...
                            elif mfi.lower() == "long" and short_pos_qty < self.max_short_trade_qty and best_ask_price > short_pos_price:
