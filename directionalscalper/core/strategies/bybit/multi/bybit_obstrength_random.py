        ...
        while True:
            ...
            # elif symbol in rotator_symbols and symbol not in open_symbols:
                ...
                if trading_allowed:
                    ...
                    self.bybit_hedge_initial_entry_obstrength(open_orders, symbol, trend, mfirsi_signal, long_dynamic_amount, short_dynamic_amount, long_pos_qty, short_pos_qty, should_long, should_short)
