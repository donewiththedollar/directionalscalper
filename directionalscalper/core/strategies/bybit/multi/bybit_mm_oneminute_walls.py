...
logging = Logger(logger_name="BybitOneMinWalls", filename="BybitOneMinWalls.log", stream=True)

symbol_locks = {}

class BybitMMOneMinuteWalls(Strategy):
        ...
        while True:
            ...
            # elif symbol in rotator_symbols and symbol not in open_symbols:
                ...
                if trading_allowed:
                    ...
                    self.bybit_entry_mm_1m_initial_only(open_orders, symbol, trend, hma_trend, mfirsi_signal, one_minute_volume, five_minute_distance, min_vol, min_dist, long_dynamic_amount, short_dynamic_amount, long_pos_qty, short_pos_qty, should_long, should_short)
