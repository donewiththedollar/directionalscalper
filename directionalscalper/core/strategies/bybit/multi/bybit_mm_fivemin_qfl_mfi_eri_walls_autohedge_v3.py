...
logging = Logger(logger_name="BybitMMFiveMinuteQFLMFIERIAutoHedgeWallsV3", filename="BybitMMFiveMinuteQFLMFIERIAutoHedgeWallsV3.log", stream=True)

symbol_locks = {}

class BybitMMFiveMinuteQFLMFIERIAutoHedgeWallsV3(Strategy):
