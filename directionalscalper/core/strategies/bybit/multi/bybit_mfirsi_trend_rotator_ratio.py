...
logging = Logger(logger_name="BybitMFIRSITrendRatio", filename="BybitMFIRSITrendRatio.log", stream=True)

class BybitMFIRSITrendRatio(Strategy):
        ...
        while True:  # Outer loop
            ...
            while True:  # Inner loop
                ...
                for s in symbols_to_manage:
                    ...
                    self.manage_mm_ratio([s], total_equity)  # Notice the square brackets around 's'
                ...
                if symbol in open_symbols:
                    ...
                    self.bybit_hedge_entry_maker_v3_ratio(open_orders, symbol, trend, mfirsi_signal, one_minute_volume, five_minute_distance, min_vol, min_dist, long_dynamic_amount, short_dynamic_amount, long_pos_qty, short_pos_qty, long_pos_price, short_pos_price, should_long, should_short, should_add_to_long, should_add_to_short)
