...
logging = Logger(logger_name="BybitAutoRotatorMFIRSIRotatorv2", filename="BybitAutoRotatorMFIRSIRotatorv2.log", stream=True)

class BybitAutoHedgeStrategyMakerMFIRSIRotatorv2(Strategy):
