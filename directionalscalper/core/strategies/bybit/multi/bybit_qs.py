        ...
        while True:
            ...
            # elif symbol in rotator_symbols and symbol not in open_symbols:
                ...
                if trading_allowed:
                    ...
                    self.bybit_initial_entry_with_qfl_and_mfi_eri(open_orders, symbol, trend, hma_trend, mfirsi_signal, eri_trend, five_minute_volume, five_minute_distance, min_vol, min_dist, long_dynamic_amount, short_dynamic_amount, long_pos_qty, short_pos_qty, should_long, should_short)
