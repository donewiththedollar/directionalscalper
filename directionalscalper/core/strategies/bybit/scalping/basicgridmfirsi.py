...
logging = Logger(logger_name="BybitBasicGridMFIRSI", filename="BybitBasicGridMFIRSI.log", stream=True)

symbol_locks = {}

class BybitBasicGridMFIRSI(BybitStrategy):
        ...
        try:
            ...
            while True:
                ...
                if symbol in rotator_symbols_standardized or (symbol in open_symbols or trading_allowed): # and instead of or
                    ...
                    self.linear_grid_handle_positions_mfirsi(
                        symbol,
                        open_symbols,
                        total_equity,
                        long_pos_qty,
