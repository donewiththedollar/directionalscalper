...
logging = Logger(logger_name="BybitQuickScalpEMATrend", filename="BybitQuickScalpEMATrend.log", stream=True)

symbol_locks = {}

class BybitQuickScalpEMATrend(BybitStrategy):
        ...
        try:
            ...
            while True:
                ...
                if symbol in rotator_symbols_standardized or (symbol in open_symbols or trading_allowed): # and instead of or
                    ...
                    self.bybit_1m_mfi_quickscalp_ema_trend(
                        open_orders,
                        symbol,
                        min_vol,
                        one_minute_volume,
