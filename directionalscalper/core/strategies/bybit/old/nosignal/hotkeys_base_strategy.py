...
logging = Logger(logger_name="BybitHotkeysBaseStrategy", filename="BybitHotkeysBaseStrategy.log", stream=True)

symbol_locks = {}

class BybitHotkeysBaseStrategy(BybitStrategy):
                ...
                if symbol in rotator_symbols_standardized or (symbol in open_symbols or trading_allowed): # and instead of or
                    ...
                    try:
                        self.hotkey_trading_strategy(
                            ...
                            tp_order_counts=defaultdict(int)
                        )

                    except Exception as e:
                        logging.info(f"Exception caught in hotkey strategy {e}")
