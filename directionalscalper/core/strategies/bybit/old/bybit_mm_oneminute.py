...
logging = Logger(logger_name="BybitOneMin", filename="BybitOneMin.log", stream=True)

symbol_locks = {}

class BybitMMOneMinute(Strategy):
    ...
    def run_single_symbol(self, symbol, rotator_symbols_standardized=None):
        ...
        while True:
            ...
            if symbol in rotator_symbols_standardized and (symbol in open_symbols or trading_allowed):
                ...
                short_take_profit, long_take_profit = self.calculate_take_profits_based_on_spread(short_pos_price, long_pos_price, symbol, one_minute_distance, previous_five_minute_distance, short_take_profit, long_take_profit)
                ...
                self.bybit_entry_mm_5m(open_orders, symbol, trend, hma_trend, mfirsi_signal, one_minute_volume, five_minute_distance, min_vol, min_dist, long_dynamic_amount, short_dynamic_amount, long_pos_qty, short_pos_qty, long_pos_price, short_pos_price, should_long, should_short, should_add_to_long, should_add_to_short)
            ...
            # elif symbol in rotator_symbols and symbol not in open_symbols:
                ...
                if trading_allowed:
                    ...
                    self.bybit_initial_entry_mm_5m(open_orders, symbol, trend, hma_trend, mfirsi_signal, one_minute_volume, five_minute_distance, min_vol, min_dist, long_dynamic_amount, short_dynamic_amount, long_pos_qty, short_pos_qty, should_long, should_short)
