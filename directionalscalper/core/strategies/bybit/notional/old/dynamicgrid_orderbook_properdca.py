...
logging = Logger(logger_name="BybitDynamicGridOBDCA", filename="BybitDynamicGridOBDCA.log", stream=True)

symbol_locks = {}

class BybitDynamicGridOBDCA(BybitStrategy):
        ...
        try:
            ...
            while self.running_long or self.running_short:
                ...
                if symbol in rotator_symbols_standardized or (symbol in open_symbols or trading_allowed): # and instead of or
                    ...
                    try:
                        self.linear_grid_hardened_gridspan_orderbook_maxposqty_properdca(
                            symbol,
                            open_symbols,
                            total_equity,
                            long_pos_price,
                        ...
                        logging.info("Something is up with variables for the grid {e}")
