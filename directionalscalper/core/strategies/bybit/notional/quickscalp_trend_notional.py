...
logging = Logger(logger_name="BybitQuickScalpTrendNotional", filename="BybitQuickScalpTrendNotional.log", stream=True)

symbol_locks = {}

class BybitQuickScalpTrendNotional(BybitStrategy):
