...
logging = Logger(logger_name="BybitDynamicGridDynamicTPLinSpaced", filename="BybitDynamicGridDynamicTPLinSpaced.log", stream=True)

symbol_locks = {}

class BybitDynamicGridDynamicTPLinSpaced(BybitStrategy):
