...
logging = Logger(logger_name="BybitDynamicGridSpanOB", filename="BybitDynamicGridSpanOB.log", stream=True)

symbol_locks = {}

class BybitDynamicGridSpanOB(BybitStrategy):
        ...
        try:
            ...
            while self.running_long or self.running_short:
                ...
                if symbol in rotator_symbols_standardized or (symbol in open_symbols or trading_allowed): # and instead of or
                    ...
                    try:
                        self.linear_grid_hardened_gridspan_orderbook_maxposqty(
                            symbol,
                            open_symbols,
                            total_equity,
                            long_pos_price,
