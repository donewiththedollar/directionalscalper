...
## Dashboard setup
- Run multi_bot `python3.11 multi_bot_instantsignal.py` or with arguments `python3.11 multi_bot_signalscreener.py --exchange bybit --account_name account_1 --strategy qsgridob --config config.json`
