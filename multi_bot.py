...
if __name__ == '__main__':
    ...
    whitelist = ['XRPUSDT, MATICUSDT, INJUSDT, LTCUSDT, AVAXUSDT, DOTUSDT, ATOMUSDT, ETCUSDT, SHIB1000USDT, UNIUSDT, FILUSDT, APTUSDT, ARBUSDT, XLMUSDT, NEARUSDT, OPUSDT, ALGOUSDT, SANDUSDT, MANAUSDT, FTMUSDT, CTSIUSDT', 'COMPUSDT', 'STMXUSDT', 'APEUSDT']  # Symbols that you want to include
