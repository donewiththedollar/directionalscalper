...
### Example short only BTCUSDT futures configuration
...
```json
{
    ...
    "bot": {
        ...
        "min_volume": 10000,
        "wallet_exposure_limit": 0.001,
        "user_defined_leverage_long": 15,
        "user_defined_leverage_short": 7,
        "upnl_profit_pct": 0.0022,
        "max_upnl_profit_pct": 0.0029,
        "auto_reduce_enabled": false,
        "auto_reduce_start_pct": 0.068,
        ...
        "shared_data_path": "data/",
        "linear_grid": {
            "max_qty_percent_long": 100,
            "max_qty_percent_short": 100,
            "auto_reduce_cooldown_enabled": false,
            "auto_reduce_cooldown_start_pct": 0.051,
            "wallet_exposure_limit_long": 0.001,
            "wallet_exposure_limit_short": 0.001,
...
``python3.11 multi_bot_nosignal_multicore.py --exchange bybit --account_name account_1 --strategy longonlyhftob --config configs/config.json``

This is just a simple example of a short only BTCUSDT strategy to show how one can utilize a single strategy for many use case scenarios on different instruments.